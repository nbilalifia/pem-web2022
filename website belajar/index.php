...
<body>
	...
	<section class="home" id="home">
		<div class="home-text">
			...
			<a href="categories.php"><button class="button" style="vertical-align:middle"><span>Mulai Sekarang! </span></button></a>
		</div>
	...
	<section class="categories" id="categories">
		...
		<div class="categories-content">
			...
			<div class="main-btn">
				<a href="categories.php" class="btn">All Categories</a>
			</div>
	...
	<section class="homecourses" id="homecourses">
		...
		<div class="home-courses-content">
			...
			<div class="course-btn">
				<a href="courses.php" class="coursebtn">All Courses</a>
			</div>
